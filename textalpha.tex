...
\begin{center}
    ...
    Text,
    welcher
	sich immer wiederholt.\cite{Memywatchandmyself}
\end{center}
Ein Mustertext ist ein an sich kurzer Text, welcher sich immer wiederholt. Ein Mustertext ist ein an sich kurzer Text, welcher sich immer wiederholt. Ein Mustertext ist ein an sich kurzer Text, welcher sich immer wiederholt. \cite{TimeisEverything}
